...
class DeveloperGuide extends Model
{
	use Searchable;
	 ...
	 */
	public static $rules = [
		'parent_id' => 'nullable|exists:developer_guides,id',
		'title' => 'required|max:255',
		'slug' => 'max:400',
		'content' => 'required|max:128000',
		'order' => 'required|min:0|max:65535',
	];

	/**
	 * A DeveloperGuide belongs to a parent
	 * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
	 */
	public function parent()
	{
		return $this->belongsTo(DeveloperGuide::class, 'parent_id');
	}

	/**
	 * A DeveloperGuide has many children
	 * @return \Illuminate\Database\Eloquent\Relations\HasMany
	 */
	public function children()
	{
		return $this->hasMany(DeveloperGuide::class, 'parent_id');
	}
	...
	public static function getCachedPages()
	{
		...
		try {
			$pages = cache()->remember('developer_guides', $minutes = (60*24), function() {
