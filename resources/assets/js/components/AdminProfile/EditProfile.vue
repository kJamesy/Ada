    ...
    <div class="mt-5">
        ...
        <form v-on:submit.prevent='updateProfile' v-if="! fetchingData">
            <div class="form-group row" v-bind:class="validationErrors.first_name ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="first_name" v-model.trim="profile.first_name" v-bind:class="validationErrors.first_name ? 'is-invalid' : ''" placeholder="First Name" autofocus>
            ...
            <div class="form-group row" v-bind:class="validationErrors.last_name ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="last_name" v-model.trim="profile.last_name" v-bind:class="validationErrors.last_name ? 'is-invalid' : ''" placeholder="Last Name">
                    <small class="invalid-feedback">
            ...
            <div class="form-group row" v-bind:class="validationErrors.username ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="username" v-model.trim="profile.username" v-bind:class="validationErrors.username ? 'is-invalid' : ''" placeholder="Username">
                    <small class="invalid-feedback">
            ...
            <div class="form-group row" v-bind:class="validationErrors.email ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="email" v-model.trim="profile.email" v-bind:class="validationErrors.email ? 'is-invalid' : ''" placeholder="Email">
                    <small class="invalid-feedback">
