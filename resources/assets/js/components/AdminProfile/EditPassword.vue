    ...
    <div class="mt-5">
        ...
        <form v-on:submit.prevent='updatePassword' v-if="! fetchingData">
            <div class="form-group row" v-bind:class="validationErrors.current_password ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="password" class="form-control" id="current_password" v-model="profile.current_password" v-bind:class="validationErrors.current_password ? 'is-invalid' : ''" placeholder="Current Password">
            ...
            <div class="form-group row" v-bind:class="validationErrors.password ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="password" class="form-control" id="password" v-model="profile.password" v-bind:class="validationErrors.password ? 'is-invalid' : ''" placeholder="New Password">
                    <small class="invalid-feedback">
            ...
            <div class="form-group row" v-bind:class="validationErrors.password_confirmation ? 'has-danger' : ''">
                ...
                <div class="col-md-8">
                    <input type="password" class="form-control" id="password_confirmation" v-model="profile.password_confirmation" v-bind:class="validationErrors.password_confirmation ? 'is-invalid' : ''" placeholder="Repeat New Password">
                    <small class="invalid-feedback">
